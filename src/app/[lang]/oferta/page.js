  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.container}>
        ...
        <p>3.9. Продавець має право анулювати Замовлення повністю або частково у разі виявлення технічної помилки, програмного збою, помилки синхронізації із системою обліку, некоректної роботи Сайту, платіжної системи або сторонніх сервісів, унаслідок яких було неправильно відображено ціну, знижку, наявність, кількість, характеристики Товару, вартість доставки або інші умови Замовлення.</p>
        <p>У разі виявлення такої помилки Продавець повідомляє Покупця про анулювання Замовлення. Якщо Замовлення було оплачене, Продавець повертає Покупцеві всю фактично сплачену суму тим самим способом, яким було здійснено оплату, якщо інший спосіб не погоджений сторонами.</p>     
      </div>
